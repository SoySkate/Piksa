...
export default function ListProductButton({listP, index, mostrarProductosLista}:any){
    ...
    return (
               <div key={index}> <button onClick={()=>mostrarProductos(listP)} className="hover:border-4 bg-white border-2 border-black rounded-xl w-14 h-14 flex justify-center items-center pb-2 font-bold m-4 ">
                {listP.nombre}
            </button></div>
    )
}